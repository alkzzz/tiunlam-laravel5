...
<div class="panel panel-default">
    <div class="panel-heading">Delete Artikel (EN)</div>
      <div class="panel-body">
        ...
        <form action="{{ route('deleteartikel_en', $artikel->slug) }}" method="post">
      	<input type="hidden" name="_method" value="DELETE">
      	<input type="hidden" name="_token" value="{{ csrf_token() }}">
      	<button type="submit" class="btn btn-lg btn-danger">Ya</button>
        <a class="btn btn-lg btn-info" href="{{ route('admin-artikel_en') }}">Tidak</a>
