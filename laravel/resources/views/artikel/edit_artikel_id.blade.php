...
{{ Session::put('id_artikel', $artikel->id) }}
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Edit Artikel (ID)</div>
           <div class="panel-body">
              @include('errors.list')
              <form action="{{ route('updateartikel_id', $artikel->slug) }}" method="post" enctype="multipart/form-data">
                ...
                <option value="{{ $artikel->kategori->id }}">{{ $artikel->kategori->nama_id }}</option>
                @foreach ($kategori as $kat)
                <option value="{{ $kat->id }}">{{ $kat->nama_id }}</option>
                @endforeach
                </select>
                </div>
                <div class="form-group">
                ...
                @endif
                <br>
                <a class="btn btn-sm btn-primary" href="{{ route('editdokumen_id') }}">Edit Dokumen</a>
                <hr>
